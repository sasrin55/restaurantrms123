                    ...
                    >
                      {isBooked && (
                        <>
                          ...
                          <div className="absolute top-1.5 right-1.5 z-20 flex items-center gap-[2px] bg-red-50 border border-red-200 rounded px-1 py-0.5 pl-[6px] pr-[6px] pt-[4px] pb-[4px] text-[16px]" data-testid={`text-booked-pax-${table.id}`}>
